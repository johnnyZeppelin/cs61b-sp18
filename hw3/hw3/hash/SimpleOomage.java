...
public class SimpleOomage implements Oomage {
    ...
    public boolean equals(Object o) {
        ...
        if (o.getClass() != SimpleOomage.class) return false;
        if (red == ((SimpleOomage) o).red &&
                green == ((SimpleOomage) o).green &&
                blue == ((SimpleOomage) o).blue) return true;
        return false;
    }

    /* Uncomment this method after you've written
       equals and failed the testHashCodeAndEqualsConsistency
       test.*/ //uncommented already
    @Override
    public int hashCode() {
        if (!USE_PERFECT_HASH) {
